  ...
  render() {
    ...
    return (
      <ScrollView style={styles.title} contentContainerStyle={styles.content}>
          ...
          <Progress.Bar style={styles.progressBar} progress={0.3} width={200} color={theme.colors.skyBlue}/>

          <View style={styles.compoundInterest}>
            <Text>
              <Text style={styles.heading1}>Compound interest</Text> is what
              most loans deal with.
            </Text>
          </View>
